...
### Results
Results show are the min runtime for each soltuion taken over 1000 runs on an M2 Macbook Air. Reading the input data from disk is not included as part of the solution here so the runtime you see is the runtime of any parsing & logic requried to solve the puzzle.
